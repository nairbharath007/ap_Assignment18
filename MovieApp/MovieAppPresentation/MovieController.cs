...
using MovieAppClassLibrary.Service;
using System;
...
namespace MovieAppPresentation
{
    internal class MovieController
    {
        ...
        private void AddMovie()
        {
            ...
            try
            {
                ...
                {
                    Console.WriteLine("A movie with the same ID or Name already exists.");
                    return;
                }
                ...
                manager.AddMovie(movieId, movieName, year, director);
                Console.WriteLine("Movie added successfully!");
            }
            catch (FormatException)
            {
